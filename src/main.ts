interface TodoItem {
  ...
  class TodoApp extends HTMLElement {
    ...
    addItem() {
      const input = this.shadowRoot!.querySelector('.new-item') as HTMLInputElement;
    ...
    render() {
      const todoListContainer = this.shadowRoot!.querySelector('.todo-list') as HTMLUListElement;
      const itemCount = this.shadowRoot!.querySelector('.item-count') as HTMLDivElement;
